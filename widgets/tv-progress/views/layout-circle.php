...
<div class="tv-progress__wrapper">
	<div class="tv-progress__circle-wrapper">
		<svg class="tv-progress__circle-svg" viewBox="0 0 100 100">
			<circle class="tv-progress__circle-track" cx="50" cy="50" r="45"></circle>
			<circle class="tv-progress__circle-fill" cx="50" cy="50" r="45" data-percentage="<?php echo esc_attr( $percent ); ?>"></circle>
		</svg>

		<div class="tv-progress__circle-content">
			<?php if ( ! empty( $settings['icon']['value'] ) ) : ?>
				<div class="tv-progress__icon">
			...
			<?php if ( ! empty( $settings['title'] ) ) : ?>
				<div class="tv-progress__title"><?php echo wp_kses_post( $settings['title'] ); ?></div>
			<?php endif; ?>
			
			<?php if ( ! empty( $settings['subtitle'] ) ) : ?>
				<div class="tv-progress__subtitle"><?php echo wp_kses_post( $settings['subtitle'] ); ?></div>
			<?php endif; ?>
		</div>
	</div>
</div>
