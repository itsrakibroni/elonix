...
class Elonix_Toolkit_Post_List_Widget extends Elonix_Widget_Base {
	...
	public function get_tv_widget_keywords() {
		return array( 'posts', 'list', 'grid', 'woo', 'cpt', 'blog', 'tvkit' );
	}
	...
	public function get_style_depends() {
		return array( 'elonix-widget-tv-post-list' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-list-container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-list-container' => 'row-gap: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-card' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-card' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-card' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'types'    => array( 'classic', 'gradient' ),
				'selector' => '{{WRAPPER}} .tv-post-card:hover',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-thumbnail' => 'width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}}  .tv-post-thumbnail' => 'height: {{SIZE}}{{UNIT}}; object-fit: cover;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-thumbnail, {{WRAPPER}} .tv-post-thumbnail img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; object-fit: cover;',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-post-thumbnail',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-thumbnail' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .tv-layout-news-list .tv-post-thumbnail, {{WRAPPER}} .tv-layout-featured_list .tv-standard-card .tv-post-thumbnail' => 'margin-right: {{SIZE}}{{UNIT}}; margin-bottom: 0;',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-post-title, {{WRAPPER}} .tv-post-title a',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .tv-post-title, {{WRAPPER}} .tv-post-title a' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-post-title a:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-post-meta, {{WRAPPER}} .tv-post-meta .tv-meta-item, {{WRAPPER}} .tv-post-meta a',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-post-meta, {{WRAPPER}} .tv-post-meta .tv-meta-item, {{WRAPPER}} .tv-post-meta a' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-post-meta a:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-meta' => 'gap: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-meta' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-post-excerpt',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-post-excerpt' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-excerpt' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-post-readmore .tv-readmore-btn',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-post-readmore .tv-readmore-btn' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-post-readmore .tv-readmore-btn' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-post-readmore .tv-readmore-btn:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-post-readmore .tv-readmore-btn:hover' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-post-readmore .tv-readmore-btn:hover',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-readmore .tv-readmore-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; display: inline-block;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-readmore .tv-readmore-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-post-badge',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-post-badge' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-post-badge' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-badge' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; line-height: 1;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-badge' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-post-list-pagination' => 'margin-top: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector'  => '{{WRAPPER}} .tv-load-more-btn',
				'condition' => array(
					'pagination_type' => 'load_more',
				),
			)
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-load-more-btn' => 'color: {{VALUE}};',
				),
				'condition' => array(
					'pagination_type' => 'load_more',
				),
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-load-more-btn' => 'background-color: {{VALUE}};',
				),
				'condition' => array(
					'pagination_type' => 'load_more',
				),
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-load-more-btn:hover' => 'color: {{VALUE}};',
				),
				'condition' => array(
					'pagination_type' => 'load_more',
				),
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-load-more-btn:hover' => 'background-color: {{VALUE}};',
				),
				'condition' => array(
					'pagination_type' => 'load_more',
				),
		...
		$this->add_group_control(
			...
			array(
				...
				'selector'  => '{{WRAPPER}} .tv-load-more-btn:hover',
				'condition' => array(
					'pagination_type' => 'load_more',
				),
			)
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-load-more-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'condition'  => array(
					'pagination_type' => 'load_more',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-load-more-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'condition'  => array(
					'pagination_type' => 'load_more',
				),
	...
	protected function render() {
		...
		$nonce = wp_create_nonce( 'tv-post-list-nonce' );
		...
		<div class="tv-post-list-wrap"
			...
			<div class="tv-post-list-container tv-layout-<?php echo esc_attr( $layout ); ?>">
				<?php
				if ( ! empty( $posts_data ) ) {
			...
			<?php if ( 'none' !== $pagination && ! empty( $posts_data ) && $max_num_pages > 1 ) : ?>
				<div class="tv-post-list-pagination">
					<?php if ( 'load_more' === $pagination ) : ?>
						<button class="tv-load-more-btn tv-btn">
							<span class="tv-btn-text"><?php echo esc_html( $settings['pagination_text'] ); ?></span>
							<span class="tv-btn-loading-icon" style="display: none;">
					...
					<?php elseif ( 'infinite_scroll' === $pagination ) : ?>
						<div class="tv-infinite-scroll-trigger">
							<span class="tv-scroll-loading-icon">
								<svg class="tv-spinner" viewBox="0 0 50 50">
									<circle class="path" cx="25" cy="25" r="20" fill="none" stroke-width="5" stroke="currentColor"></circle>
								</svg>
							</span>
	...
	public static function render_single_post( $item, $settings, $layout ) {
		...
		if ( $show_badge ) {
			...
			if ( ! empty( $badge_text ) ) {
				$badge_html = sprintf( '<span class="tv-post-badge">%s</span>', esc_html( $badge_text ) );
			}
		}

		// Calculate class names
		$card_classes   = array( 'tv-post-card' );
		...
		<article class="<?php echo esc_attr( implode( ' ', $card_classes ) ); ?>">
			...
			<?php elseif ( ! empty( $badge_html ) ) : ?>
				<div class="tv-post-badge-wrapper">
					<?php echo $badge_html; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
				</div>
			<?php endif; ?>

			<div class="tv-post-content">

				<?php
				if ( $show_title ) {
					$title_tag = ! empty( $settings['title_tag'] ) ? $settings['title_tag'] : 'h3';
					printf(
						'<%1$s class="tv-post-title"><a href="%2$s">%3$s</a></%1$s>',
						esc_attr( $title_tag ),
						esc_url( $item['url'] ),
						esc_html( $item['title'] )
					);
				...
				<?php if ( $show_meta && ! empty( $settings['meta_elements'] ) ) : ?>
					<div class="tv-post-meta">
						<?php if ( in_array( 'author', $settings['meta_elements'], true ) ) : ?>
							<span class="tv-meta-item tv-meta-author">
						...
						<?php if ( in_array( 'date', $settings['meta_elements'], true ) ) : ?>
							<span class="tv-meta-item tv-meta-date">
								<?php echo esc_html( $item['date'] ); ?>
							</span>
						<?php endif; ?>

						<?php if ( in_array( 'comments', $settings['meta_elements'], true ) ) : ?>
							<span class="tv-meta-item tv-meta-comments">
								<?php
						...
						<?php if ( in_array( 'categories', $settings['meta_elements'], true ) && ! empty( $item['categories'] ) ) : ?>
							<span class="tv-meta-item tv-meta-categories">
								<?php
								$cat_links = array();
						...
						<?php if ( in_array( 'reading_time', $settings['meta_elements'], true ) ) : ?>
							<span class="tv-meta-item tv-meta-reading-time">
								<?php
				...
				<?php if ( $show_excerpt && ! empty( $item['excerpt'] ) ) : ?>
					<div class="tv-post-excerpt">
						<?php echo esc_html( $item['excerpt'] ); ?>
					</div>
				<?php endif; ?>

				<?php if ( $show_read_more ) : ?>
					<div class="tv-post-readmore">
						<a href="<?php echo esc_url( $item['url'] ); ?>" class="tv-readmore-btn">
