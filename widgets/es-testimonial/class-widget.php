...
class Elonix_Toolkit_Testimonial_Widget extends Elonix_Widget_Base {
	...
	public function get_keywords() {
		return array( 'testimonial', 'review', 'quote', 'carousel', 'grid', 'eskit' );
	}

	public function get_style_depends() {
		return array( 'elonix-widget-es-testimonial', 'swiper' );
	}
	...
	protected function register_content_layout_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'default'   => 3,
				'selectors' => array(
					'{{WRAPPER}} .es-testimonial__grid' => '--es-testimonial-columns: {{VALUE}};',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-testimonial__grid' => '--es-testimonial-gap-x: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-testimonial__grid' => '--es-testimonial-gap-y: {{SIZE}}{{UNIT}};',
				),
			)
		);
	...
	protected function register_style_card_controls() {
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'card_bg',
				'selector' => '{{WRAPPER}} .es-testimonial__item',
			)
		);
		$this->add_group_control(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-testimonial__item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'card_padding',
			array(
				...
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'card_margin',
			array(
				...
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_group_control(
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'card_bg_hover',
				'selector' => '{{WRAPPER}} .es-testimonial__item:hover',
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Border::get_type(),
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-testimonial__item:hover' => 'transform: translateY({{SIZE}}{{UNIT}});' ),
			)
		);
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-testimonial__item' => 'transition: all {{SIZE}}s ease;' ),
			)
		);
		$this->end_controls_tab();
	...
	protected function register_style_content_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-testimonial__content',
			)
		);
		$this->add_control(
			'content_color',
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-testimonial__content' => 'color: {{VALUE}};' ),
			)
		);
		$this->add_responsive_control(
			'content_alignment',
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-testimonial__content' => 'text-align: {{VALUE}};' ),
			)
		);
		$this->add_responsive_control(
			'content_max_width',
			array(
				...
				'selectors'  => array( '{{WRAPPER}} .es-testimonial__content' => 'max-width: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'content_margin',
			array(
				'label'     => esc_html__( 'Margin', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->end_controls_section();
	}
	...
	protected function register_style_quote_icon_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__quote-icon' => 'font-size: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_control(
			'quote_icon_color',
			array(
				'label'     => esc_html__( 'Color', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__quote-icon' => 'color: {{VALUE}};' ),
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Background::get_type(),
			array(
				'name'     => 'quote_icon_bg',
				'selector' => '{{WRAPPER}} .es-testimonial__quote-icon',
			)
		);
		$this->add_responsive_control(
			'quote_icon_padding',
			array(
				'label'     => esc_html__( 'Padding', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__quote-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'quote_icon_radius',
			array(
				'label'     => esc_html__( 'Border Radius', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__quote-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'quote_icon_margin',
			array(
				'label'     => esc_html__( 'Margin', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__quote-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_control(
			'quote_icon_opacity',
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-testimonial__quote-icon' => 'opacity: {{SIZE}};' ),
			)
		);
		$this->end_controls_section();
	}
	...
	protected function register_style_avatar_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-testimonial__avatar img' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'avatar_radius',
			array(
				'label'     => esc_html__( 'Border Radius', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__avatar img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Border::get_type(),
			array(
				'name'     => 'avatar_border',
				'selector' => '{{WRAPPER}} .es-testimonial__avatar img',
			)
		);
		$this->add_responsive_control(
			'avatar_spacing',
			array(
				...
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__avatar' => 'margin-right: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_control(
			'avatar_object_fit',
			array(
				...
				'default'   => 'cover',
				'selectors' => array( '{{WRAPPER}} .es-testimonial__avatar img' => 'object-fit: {{VALUE}};' ),
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Background::get_type(),
	...
	protected function register_style_company_logo_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-testimonial__company-logo img' => 'width: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'company_logo_height',
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-testimonial__company-logo img' => 'height: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-testimonial__company-logo img' => 'max-width: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			...
			array(
				'label'     => esc_html__( 'Spacing', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__company-logo' => 'margin-bottom: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-testimonial__company-logo img' => 'opacity: {{SIZE}};' ),
			)
		);
		$this->add_control(
			...
			array(
				...
				'default'   => 'contain',
				'selectors' => array( '{{WRAPPER}} .es-testimonial__company-logo img' => 'object-fit: {{VALUE}};' ),
			)
		);
		$this->end_controls_section();
	}
	...
	protected function register_style_client_name_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-testimonial__client-name',
			)
		);
		$this->add_control(
			'client_name_color',
			array(
				'label'     => esc_html__( 'Color', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__client-name' => 'color: {{VALUE}};' ),
			)
		);
		$this->add_responsive_control(
			'client_name_margin',
			array(
				'label'     => esc_html__( 'Margin', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__client-name' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->end_controls_section();
	}
	...
	protected function register_style_designation_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-testimonial__designation',
			)
		);
		$this->add_control(
			'designation_color',
			array(
				'label'     => esc_html__( 'Color', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__designation' => 'color: {{VALUE}};' ),
			)
		);
		$this->add_responsive_control(
			'designation_margin',
			array(
				'label'     => esc_html__( 'Margin', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__designation' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->end_controls_section();
	}
	...
	protected function register_style_company_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-testimonial__company',
			)
		);
		$this->add_control(
			'company_color',
			array(
				'label'     => esc_html__( 'Color', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__company' => 'color: {{VALUE}};' ),
			)
		);
		$this->add_responsive_control(
			'company_margin',
			array(
				'label'     => esc_html__( 'Margin', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__company' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->end_controls_section();
	}
	...
	protected function register_style_rating_controls() {
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'rating_bg',
				'selector' => '{{WRAPPER}} .es-testimonial__rating',
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Border::get_type(),
		...
		$this->add_responsive_control(
			...
			array(
				'label'     => esc_html__( 'Border Radius', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__rating' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'rating_padding',
			array(
				'label'     => esc_html__( 'Padding', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__rating' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'rating_gap',
			array(
				...
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__rating' => 'gap: {{SIZE}}{{UNIT}};' ),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__rating-icon' => 'font-size: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_control(
			'rating_icon_color',
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__rating-icon' => 'color: {{VALUE}};' ),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector'  => '{{WRAPPER}} .es-testimonial__rating-text',
				'separator' => 'before',
			)
		);
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .es-testimonial__rating-text' => 'color: {{VALUE}};' ),
			)
		);
	...
	protected function render() {
		...
		$wrapper_classes = array(
			'es-testimonial',
			'es-testimonial--' . esc_attr( $settings['layout_mode'] ),
		);
