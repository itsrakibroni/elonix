...
class Elonix_Toolkit_Post_Comments_Ajax {
	public function __construct() {
		add_action( 'wp_ajax_tv_submit_comment', array( $this, 'ajax_submit_comment' ) );
		add_action( 'wp_ajax_nopriv_tv_submit_comment', array( $this, 'ajax_submit_comment' ) );
	}
	...
	public function ajax_submit_comment() {
		...
		// phpcs:ignore WordPress.Security.NonceVerification.Missing
		$avatar_size = isset( $_POST['tv_avatar_size'] ) ? intval( wp_unslash( $_POST['tv_avatar_size'] ) ) : 60;
