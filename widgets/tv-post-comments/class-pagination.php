...
class Elonix_Toolkit_Post_Comments_Pagination {
	...
	public function get_current_page() {
		// Respect our custom tv_cpage parameter first to avoid redirect_canonical issues
		if ( isset( $_GET['tv_cpage'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
			$page = (int) wp_unslash( $_GET['tv_cpage'] ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended, WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
