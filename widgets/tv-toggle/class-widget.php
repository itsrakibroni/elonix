...
class Elonix_Toolkit_Toggle_Widget extends Elonix_Widget_Base {
	...
	public function get_keywords() {
		return [ 'toggle', 'switcher', 'visibility', 'tabs', 'tvkit' ];
	}

	public function get_style_depends() {
		return [ 'elonix-widget-tv-toggle' ];
	}
	...
	protected function register_content_layout_controls() {
		...
		$this->add_control(
			...
			[
				...
				'frontend_available' => true,
				'selectors'          => [
					'{{WRAPPER}} .tv-toggle__list' => 'flex-direction: {{VALUE}} === "vertical" ? column : row;',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'frontend_available' => true,
				'selectors'          => [
					'{{WRAPPER}} .tv-toggle__wrapper' => 'justify-content: {{VALUE}};',
					'{{WRAPPER}} .tv-toggle__list' => 'justify-content: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'            => 'center',
				'selectors'          => [
					'{{WRAPPER}} .tv-toggle__button' => 'justify-content: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'            => 'center',
				'selectors'          => [
					'{{WRAPPER}} .tv-toggle__button' => 'align-items: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'frontend_available' => true,
				'selectors'          => [
					'{{WRAPPER}} .tv-toggle__item' => 'flex: 1;',
					'{{WRAPPER}} .tv-toggle__button' => 'width: 100%;',
				],
			]
		);
	...
	protected function register_style_toggle_controls() {
		...
		$states = [
			'normal'   => [ 'label' => esc_html__( 'Normal', 'elonix' ), 'selector' => '{{WRAPPER}} .tv-toggle__button' ],
			'hover'    => [ 'label' => esc_html__( 'Hover', 'elonix' ), 'selector' => '{{WRAPPER}} .tv-toggle__button:hover' ],
			'active'   => [ 'label' => esc_html__( 'Active', 'elonix' ), 'selector' => '{{WRAPPER}} .tv-toggle__button.tv-toggle__button--active' ],
			'focus'    => [ 'label' => esc_html__( 'Focus', 'elonix' ), 'selector' => '{{WRAPPER}} .tv-toggle__button:focus-visible' ],
			'disabled' => [ 'label' => esc_html__( 'Disabled', 'elonix' ), 'selector' => '{{WRAPPER}} .tv-toggle__button:disabled, {{WRAPPER}} .tv-toggle__button[disabled]' ],
		];
	...
	protected function register_style_typography_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tv-toggle__button',
			]
		);
	...
	protected function register_style_icon_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .tv-toggle__icon' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', 'rem' ],
				'selectors' => [
					'{{WRAPPER}} .tv-toggle__button' => 'gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		foreach ( $states as $state => $state_data ) {
			...
			$this->add_control(
				...
				[
					...
					'type'      => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
						$state_data['selector'] . ' .tv-toggle__icon' => 'color: {{VALUE}}; fill: {{VALUE}};',
					],
				]
			);
			$this->end_controls_tab();
	...
	protected function register_style_indicator_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .tv-toggle__indicator' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', 'rem', '%' ],
				'selectors' => [
					'{{WRAPPER}} .tv-toggle__indicator' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tv-toggle__indicator',
			]
		);
	...
	protected function register_style_spacing_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', 'rem', '%' ],
				'selectors' => [
					'{{WRAPPER}} .tv-toggle__button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', 'rem', '%' ],
				'selectors' => [
					'{{WRAPPER}} .tv-toggle__button' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', 'rem', '%' ],
				'selectors' => [
					'{{WRAPPER}} .tv-toggle__list' => 'gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function register_style_animation_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .tv-toggle__button' => 'transition-duration: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .tv-toggle__indicator' => 'transition-duration: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .tv-toggle__icon' => 'transition-duration: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .tv-transition-enabled' => 'transition-duration: {{SIZE}}{{UNIT}} !important;',
				],
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'ease',
				'selectors' => [
					'{{WRAPPER}} .tv-toggle__button' => 'transition-timing-function: {{VALUE}};',
					'{{WRAPPER}} .tv-toggle__indicator' => 'transition-timing-function: {{VALUE}};',
					'{{WRAPPER}} .tv-toggle__icon' => 'transition-timing-function: {{VALUE}};',
					'{{WRAPPER}} .tv-transition-enabled' => 'transition-timing-function: {{VALUE}} !important;',
				],
			]
		);
