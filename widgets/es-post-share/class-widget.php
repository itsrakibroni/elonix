...
class Elonix_Toolkit_Post_Share_Widget extends Elonix_Social_Base_Widget {
	...
	public function get_es_widget_keywords() {
		return array( 'post', 'share', 'social', 'facebook', 'twitter', 'linkedin', 'whatsapp', 'pinterest', 'reddit', 'telegram', 'email', 'copy', 'popup', 'modal', 'eskit' );
	}
	...
	public function get_style_depends() {
		return array( 'elonix-widget-es-social-icons', 'elonix-widget-es-post-share' );
	}
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-share-title',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-share-title' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-share-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => esc_html__( 'Typography', 'elonix' ),
				'selector' => '{{WRAPPER}} .es-copy-success-toast',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#ffffff',
				'selectors' => array(
					'{{WRAPPER}} .es-copy-success-toast' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#10b981',
				'selectors' => array(
					'{{WRAPPER}} .es-copy-success-toast' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#ffffff',
				'selectors' => array(
					'{{WRAPPER}} .es-copy-success-toast svg' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-copy-success-toast' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-copy-success-toast' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => esc_html__( 'Typography', 'elonix' ),
				'selector' => '{{WRAPPER}} .es-share-modal-trigger',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#ffffff',
				'selectors' => array(
					'{{WRAPPER}} .es-share-modal-trigger' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#6366f1',
				'selectors' => array(
					'{{WRAPPER}} .es-share-modal-trigger' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-share-modal-trigger' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-share-modal-trigger' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-share-modal-trigger:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#4f46e5',
				'selectors' => array(
					'{{WRAPPER}} .es-share-modal-trigger:hover' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-share-modal-trigger:hover',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-share-modal-overlay' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#ffffff',
				'selectors' => array(
					'{{WRAPPER}} .es-share-modal-box' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-share-modal-box' => 'max-width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-share-modal-box' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-share-modal-box',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-share-modal-box' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-share-modal-title',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#0f172a',
				'selectors' => array(
					'{{WRAPPER}} .es-share-modal-title' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#64748b',
				'selectors' => array(
					'{{WRAPPER}} .es-share-modal-close' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#0f172a',
				'selectors' => array(
					'{{WRAPPER}} .es-share-modal-close:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#f1f5f9',
				'selectors' => array(
					'{{WRAPPER}} .es-share-modal-close:hover' => 'background-color: {{VALUE}};',
				),
			)
		);
	...
	protected function render() {
		...
		?>
		<div class="es-post-share-container <?php echo esc_attr( $is_modal ? 'es-share-mode-modal' : 'es-share-mode-direct' ); ?>">
			
			<?php if ( $is_modal ) : ?>
				<button class="es-share-modal-trigger" aria-haspopup="dialog" aria-expanded="false">
					<?php
				...
				<div class="es-share-modal-overlay" aria-hidden="true">
					<div class="es-share-modal-box" role="dialog" aria-modal="true" aria-label="<?php echo esc_attr( $settings['modal_popup_title'] ); ?>">
						<button class="es-share-modal-close" aria-label="<?php esc_attr_e( 'Close Share Window', 'elonix' ); ?>">
							<i class="fas fa-times" aria-hidden="true"></i>
						</button>
						
						<?php if ( ! empty( $settings['modal_popup_title'] ) ) : ?>
							<div class="es-share-modal-header">
								<h4 class="es-share-modal-title"><?php echo esc_html( $settings['modal_popup_title'] ); ?></h4>
							</div>
						<?php endif; ?>

						<div class="es-share-modal-body">
			<?php endif; ?>

			<?php if ( ! $is_modal && ! empty( $settings['share_text'] ) ) : ?>
				<div class="es-post-share-header">
					<?php
					$tag = ! empty( $settings['share_text_tag'] ) ? $settings['share_text_tag'] : 'h5';
					echo '<' . esc_attr( $tag ) . ' class="es-share-title">' . esc_html( $settings['share_text'] ) . '</' . esc_attr( $tag ) . '>';
					?>
				</div>
			<?php endif; ?>
			...
			<div class="elonix-social-icons-wrapper">
				...
				foreach ( $settings['share_networks_list'] as $index => $item ) :
					...
					switch ( $network ) {
						...
						case 'copy_link':
							$share_url = '#';
							$this->add_render_attribute( $item_key, 'data-es-copy-url', $post_url );
							$this->add_render_attribute( $item_key, 'data-es-copy-success', ! empty( $settings['copy_success_message'] ) ? $settings['copy_success_message'] : esc_html__( 'Copied!', 'elonix' ) );
							break;
					}
					...
					if ( 'email' !== $network && 'copy_link' !== $network ) {
						if ( 'yes' === $settings['open_share_popup'] && 'browser' === $settings['popup_type'] ) {
							$this->add_render_attribute( $item_key, 'data-es-share-popup', 'true' );
							$this->add_render_attribute( $item_key, 'data-es-popup-width', ! empty( $settings['popup_width'] ) ? $settings['popup_width'] : 600 );
							$this->add_render_attribute( $item_key, 'data-es-popup-height', ! empty( $settings['popup_height'] ) ? $settings['popup_height'] : 500 );
						} else {
					...
					$item_classes = 'es-social-item es-social-platform-' . esc_attr( $network );
					if ( ! empty( $item['_id'] ) ) {
