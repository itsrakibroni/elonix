...
class Elonix_Toolkit_Post_Info_Widget extends Elonix_Widget_Base {
	...
	public function get_es_widget_keywords() {
		return array( 'post', 'info', 'meta', 'author', 'date', 'category', 'tag', 'comments', 'reading', 'views', 'custom', 'eskit' );
	}
	...
	public function get_style_depends() {
		return array( 'elonix-widget-es-post-info' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} .es-post-info-avatar' => 'width: {{SIZE}}px; height: {{SIZE}}px;',
				),
				'condition' => array(
					'meta_type'   => 'author',
					'show_avatar' => 'yes',
		...
		$repeater->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} .es-post-info-icon.es-icon-before' => 'margin-right: {{SIZE}}px;',
					'{{WRAPPER}} {{CURRENT_ITEM}} .es-post-info-icon.es-icon-after'  => 'margin-left: {{SIZE}}px;',
				),
				'condition' => array(
					'show_icon!' => 'none',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'default'   => 'left',
				'selectors' => array(
					'{{WRAPPER}} .es-post-info-container' => 'justify-content: {{VALUE}}; text-align: {{VALUE}};',
					'{{WRAPPER}} .es-post-info-container.es-layout-list' => 'align-items: {{VALUE}} === "center" ? "center" : ({{VALUE}} === "right" ? "flex-end" : "flex-start");',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-post-info-container' => 'gap: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-post-info-separator' => 'color: {{VALUE}};',
				),
				'condition' => array(
					'layout'          => 'inline',
					'separator_type!' => 'none',
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'selectors' => array(
					'{{WRAPPER}} .es-post-info-separator' => 'font-size: {{SIZE}}{{UNIT}};',
				),
				'condition' => array(
					'layout'          => 'inline',
					'separator_type!' => 'none',
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'selectors' => array(
					'{{WRAPPER}} .es-post-info-separator' => 'padding-left: {{SIZE}}{{UNIT}}; padding-right: {{SIZE}}{{UNIT}};',
				),
				'condition' => array(
					'layout'          => 'inline',
					'separator_type!' => 'none',
		...
		$this->add_group_control(
			...
			array(
				...
				'selector'  => '{{WRAPPER}} .es-post-info-container',
				'separator' => 'before',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em', 'rem' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-post-info-container' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em', 'rem' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-post-info-container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'separator'  => 'before',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em', 'rem' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-post-info-container' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-post-info-item' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-post-info-item' => '--es-post-info-hover-color: {{VALUE}};',
					'{{WRAPPER}} .es-post-info-item a:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-post-info-item',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-post-info-icon' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-post-info-item:hover .es-post-info-icon' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'selectors' => array(
					'{{WRAPPER}} .es-post-info-icon i'   => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .es-post-info-icon svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				),
			)
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'container', 'class', 'es-post-info-container es-layout-' . esc_attr( $layout ) );
		...
		if ( 'inline' === $layout && ! empty( $settings['separator_type'] ) && 'none' !== $settings['separator_type'] ) {
			...
			if ( ! empty( $sep_char ) ) {
				$separator_html = '<span class="es-post-info-separator">' . esc_html( $sep_char ) . '</span>';
			}
		}
		...
		<ul <?php $this->print_render_attribute_string( 'container' ); ?>>
			...
			foreach ( $valid_items as $index => $item_bundle ) {
				...
				$this->add_render_attribute( $item_key, 'class', 'es-post-info-item elementor-repeater-item-' . esc_attr( $item_id ) );
				...
				if ( ! empty( $data['avatar'] ) && 'author' === $item['meta_type'] && 'yes' === $item['show_avatar'] ) {
					$icon_html = '<span class="es-post-info-icon es-icon-' . esc_attr( $icon_position ) . '"><img class="es-post-info-avatar" src="' . esc_url( $data['avatar'] ) . '" alt="' . esc_attr( $data['text'] ) . '" /></span>';
					...
					$icon_html = '<span class="es-post-info-icon es-icon-' . esc_attr( $icon_position ) . '">' . $rendered_icon . '</span>';
				} elseif ( 'default' === $item['show_icon'] && ! empty( $data['default_icon'] ) ) {
					$icon_html = '<span class="es-post-info-icon es-icon-' . esc_attr( $icon_position ) . '"><i class="' . esc_attr( $data['default_icon'] ) . '" aria-hidden="true"></i></span>';
				}

				// Determine Text HTML
				$text_html = '<span class="es-post-info-text">';
				if ( ! empty( $item['text_prefix'] ) ) {
					$text_html .= '<span class="es-post-info-prefix">' . esc_html( $item['text_prefix'] ) . '</span> ';
				}
				...
				if ( ! empty( $data['terms_list'] ) ) {
					...
					foreach ( $data['terms_list'] as $term ) {
						...
						if ( ! empty( $term['url'] ) && 'yes' === $item['link_enabled'] ) {
							$terms_links[] = '<a href="' . esc_url( $term['url'] ) . '" class="es-post-info-term-link">' . $term_text . '</a>';
						} else {
							$terms_links[] = '<span class="es-post-info-term-link">' . $term_text . '</span>';
						}
					}
					$text_html .= '<span class="es-post-info-terms">' . implode( ', ', $terms_links ) . '</span>';
				} else {
					$text_html .= wp_kses_post( $data['text'] );
				}

				if ( ! empty( $item['text_suffix'] ) ) {
					$text_html .= ' <span class="es-post-info-suffix">' . esc_html( $item['text_suffix'] ) . '</span>';
				}
				$text_html .= '</span>';
				?>
