...
class Elonix_Toolkit_Featured_Image_Widget extends Elonix_Widget_Base {
	...
	public function get_es_widget_keywords() {
		return array( 'featured', 'image', 'thumbnail', 'post', 'page', 'archive', 'dynamic', 'eskit' );
	}
	...
	public function get_style_depends() {
		return array( 'elonix-widget-es-featured-image' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-featured-image-container img' => 'object-fit: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-featured-image-container img' => 'object-position: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-featured-image-container img' => 'aspect-ratio: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-featured-image-container img' => 'width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-featured-image-container img' => 'max-width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-featured-image-container img' => 'height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-featured-image-container img' => 'min-height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-featured-image-container img' => 'max-height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'default'   => 'center',
				'selectors' => array(
					'{{WRAPPER}} .es-featured-image-container' => 'text-align: {{VALUE}};',
					'{{WRAPPER}} .es-featured-image-container img' => 'margin-left: {{VALUE}} === "left" ? "0" : ({{VALUE}} === "right" ? "auto" : "auto"); margin-right: {{VALUE}} === "right" ? "0" : ({{VALUE}} === "left" ? "auto" : "auto");',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-featured-image-container img' => 'opacity: {{SIZE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-featured-image-overlay' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'css_filters',
				'selector' => '{{WRAPPER}} .es-featured-image-container img',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-featured-image-container:hover img' => 'opacity: {{SIZE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-featured-image-container:hover .es-featured-image-overlay' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-featured-image-container:hover img',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-featured-image-container img' => 'transition: all {{SIZE}}ms ease;',
					'{{WRAPPER}} .es-featured-image-overlay'       => 'transition: all {{SIZE}}ms ease;',
				),
				'separator' => 'before',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'      => 'border',
				'selector'  => '{{WRAPPER}} .es-featured-image-container img, {{WRAPPER}} .es-featured-image-container .es-featured-image-overlay',
				'separator' => 'before',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-featured-image-container img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .es-featured-image-overlay'       => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'background',
				'selector' => '{{WRAPPER}} .es-featured-image-container',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em', 'rem' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-featured-image-container' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'separator'  => 'before',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em', 'rem' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-featured-image-container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-featured-image-caption' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-featured-image-caption',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em', 'rem' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-featured-image-caption' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em', 'rem' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-featured-image-caption' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
	...
	protected function render() {
		...
		// Add Wrapper Classes
		$this->add_render_attribute( 'wrapper', 'class', 'es-featured-image-container' );

		if ( ! empty( $settings['hover_effect'] ) && 'none' !== $settings['hover_effect'] ) {
			$this->add_render_attribute( 'wrapper', 'class', 'es-effect-' . $settings['hover_effect'] );
		}

		if ( 'yes' === $settings['show_caption'] && 'overlay' === $settings['caption_position'] ) {
			$this->add_render_attribute( 'wrapper', 'class', 'es-caption-overlay' );
		}
		...
		if ( ! empty( $link_url ) ) {
			...
			$this->add_render_attribute( 'link', 'class', 'es-featured-image-link' );
		...
		<div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
			...
			<div class="es-featured-image-overlay"></div>
			...
			<?php if ( ! empty( $caption ) ) : ?>
				<div class="es-featured-image-caption">
