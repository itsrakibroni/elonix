...
class Elonix_Toolkit_Gallery_Widget extends Elonix_Widget_Base {
	...
	public function get_keywords() {
		return array( 'gallery', 'image', 'photo', 'portfolio', 'grid', 'masonry', 'eskit' );
	}

	public function get_style_depends() {
		return array( 'elonix-widget-es-gallery' );
	}

	public function get_script_depends() {
		return array( 'elonix-widget-es-gallery', 'isotope', 'imagesloaded' );
	}
	...
	protected function register_content_layout_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'default'   => 3,
				'selectors' => array(
					'{{WRAPPER}} .es-gallery__grid' => '--es-gallery-columns: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-gallery__grid' => '--es-gallery-gap-x: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-gallery__grid' => '--es-gallery-gap-y: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-gallery__image' => 'aspect-ratio: {{SIZE}};',
				),
				'condition' => array(
					'layout_mode' => 'masonry',
				),
	...
	protected function register_content_load_more_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'default'   => 'center',
				'selectors' => array(
					'{{WRAPPER}} .es-gallery__load-more-wrapper' => 'justify-content: {{VALUE}};',
				),
				'condition' => array( 'enable_load_more' => 'yes' ),
			)
		);
	...
	protected function register_style_card_controls() {
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'card_bg',
				'selector' => '{{WRAPPER}} .es-gallery__item',
			)
		);
		$this->add_group_control(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-gallery__item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'card_padding',
			array(
				...
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-gallery__item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'card_margin',
			array(
				...
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-gallery__item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_group_control(
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'card_bg_hover',
				'selector' => '{{WRAPPER}} .es-gallery__item:hover',
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Border::get_type(),
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-gallery__item:hover' => 'transform: translateY({{SIZE}}{{UNIT}});' ),
			)
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-gallery__item' => 'transition: all {{SIZE}}s ease;' ),
				'separator' => 'before',
			)
		);
		$this->end_controls_section();
	...
	protected function register_style_image_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-gallery__image img' => 'opacity: {{SIZE}};' ),
			)
		);
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-gallery__image img',
			)
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-gallery__item:hover .es-gallery__image img' => 'opacity: {{SIZE}};' ),
			)
		);
		$this->add_control(
			'image_scale_hover',
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-gallery__item:hover .es-gallery__image img' => 'transform: scale({{SIZE}});' ),
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Css_Filter::get_type(),
			array(
				...
				'selector' => '{{WRAPPER}} .es-gallery__item:hover .es-gallery__image img',
			)
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-gallery__image img' => 'transition: all {{SIZE}}s ease;' ),
				'separator' => 'before',
			)
		);
		$this->end_controls_section();
	...
	protected function register_style_overlay_controls() {
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'overlay_bg',
				'selector' => '{{WRAPPER}} .es-gallery__overlay',
			)
		);
		$this->add_control(
			'overlay_opacity',
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-gallery__overlay' => 'opacity: {{SIZE}};' ),
			)
		);
		$this->end_controls_tab();
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-gallery__item:hover .es-gallery__overlay',
			)
		);
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-gallery__item:hover .es-gallery__overlay' => 'opacity: {{SIZE}};' ),
			)
		);
		$this->end_controls_tab();
	...
	protected function register_style_content_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				'label'     => esc_html__( 'Padding', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-gallery__content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'content_alignment',
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-gallery__content' => 'text-align: {{VALUE}};' ),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector'  => '{{WRAPPER}} .es-gallery__title',
				'condition' => array( 'show_title' => 'yes' ),
			)
		);
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-gallery__title' => 'color: {{VALUE}};' ),
				'condition' => array( 'show_title' => 'yes' ),
			)
		);
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'selectors' => array( '{{WRAPPER}} .es-gallery__title' => 'margin-bottom: {{SIZE}}{{UNIT}};' ),
				'condition' => array( 'show_title' => 'yes' ),
			)
		);
	...
	protected function register_style_badge_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-gallery__badge',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .es-gallery__badge' => 'color: {{VALUE}};' ),
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Background::get_type(),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Text Color', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .es-gallery__item:hover .es-gallery__badge' => 'color: {{VALUE}};' ),
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Background::get_type(),
			array(
				'name'     => 'badge_bg_hover',
				'selector' => '{{WRAPPER}} .es-gallery__item:hover .es-gallery__badge',
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Border::get_type(),
		...
		$this->add_responsive_control(
			...
			array(
				'label'     => esc_html__( 'Padding', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-gallery__badge' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
				'separator' => 'before',
			)
		);
		$this->add_responsive_control(
			...
			array(
				'label'     => esc_html__( 'Border Radius', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-gallery__badge' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'badge_margin',
			array(
				...
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-gallery__badge' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->end_controls_section();
	}
	...
	protected function register_style_filter_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-gallery__filter-bar' => 'justify-content: {{VALUE}};' ),
			)
		);
		$this->add_responsive_control(
			'filter_gap',
			array(
				...
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'selectors' => array( '{{WRAPPER}} .es-gallery__filter-bar' => 'gap: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'filter_margin',
			array(
				...
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'selectors' => array( '{{WRAPPER}} .es-gallery__filter-bar' => 'margin-bottom: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			array(
				...
				'selector' => '{{WRAPPER}} .es-gallery__filter-btn',
			)
		);
		$this->add_responsive_control(
			'filter_padding',
			array(
				'label'     => esc_html__( 'Padding', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-gallery__filter-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'filter_radius',
			array(
				'label'     => esc_html__( 'Border Radius', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-gallery__filter-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Text Color', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .es-gallery__filter-btn' => 'color: {{VALUE}};' ),
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Background::get_type(),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Text Color', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .es-gallery__filter-btn:hover' => 'color: {{VALUE}};' ),
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Background::get_type(),
			array(
				...
				'selector' => '{{WRAPPER}} .es-gallery__filter-btn:hover',
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Border::get_type(),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Text Color', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .es-gallery__filter-btn.es-active' => 'color: {{VALUE}};' ),
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Background::get_type(),
			array(
				...
				'selector' => '{{WRAPPER}} .es-gallery__filter-btn.es-active',
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Border::get_type(),
	...
	protected function register_style_loader_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .es-gallery__loader-spinner' => 'border-top-color: {{VALUE}};' ),
			)
		);
		$this->add_control(
			'loader_bg',
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .es-gallery__loader' => 'background-color: {{VALUE}};' ),
			)
		);
		$this->add_responsive_control(
			'loader_size',
			array(
				...
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'selectors' => array( '{{WRAPPER}} .es-gallery__loader-spinner' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'loader_padding',
			array(
				'label'     => esc_html__( 'Padding', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-gallery__loader' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->end_controls_section();
	}
	...
	protected function register_style_empty_state_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-gallery__empty',
			)
		);
		$this->add_control(
			'empty_color',
			array(
				'label'     => esc_html__( 'Text Color', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .es-gallery__empty' => 'color: {{VALUE}};' ),
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Background::get_type(),
		...
		$this->add_responsive_control(
			...
			array(
				'label'     => esc_html__( 'Padding', 'elonix' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .es-gallery__empty' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'empty_alignment',
			array(
				...
				'selectors' => array( '{{WRAPPER}} .es-gallery__empty' => 'text-align: {{VALUE}};' ),
			)
		);
		$this->end_controls_section();
	}
	...
	protected function register_style_load_more_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-gallery__load-more-btn',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array(
					'{{WRAPPER}} .es-gallery__load-more-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array(
					'{{WRAPPER}} .es-gallery__load-more-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array(
					'{{WRAPPER}} .es-gallery__load-more-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-gallery__load-more-btn' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-gallery__load-more-btn:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-gallery__load-more-btn:hover',
			)
		);
	...
	protected function render() {
		...
		$wrapper_classes = array(
			'es-gallery',
			'es-gallery--' . esc_attr( $settings['layout_mode'] ),
		);
		...
		if ( $is_load_more_enabled ) {
			$ajax_settings   = array(
				...
				'nonce'     => wp_create_nonce( 'es_gallery_ajax_nonce' ),
				'limit'     => absint( $settings['items_per_click'] ),
			);
			$wrapper_attrs[] = 'data-ajax-settings="' . esc_attr( wp_json_encode( $ajax_settings ) ) . '"';
		}
