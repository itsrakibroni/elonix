...
?>
<nav class="es-gallery__filter-bar" aria-label="<?php esc_attr_e( 'Gallery Filter', 'elonix' ); ?>">
	<button type="button" class="es-gallery__filter-btn es-active" data-filter="*" aria-pressed="true">
		<?php echo esc_html( $settings['filter_all_label'] ); ?>
	</button>
	<?php foreach ( $categories as $slug => $name ) : ?>
		<button type="button" class="es-gallery__filter-btn" data-filter="<?php echo esc_attr( $slug ); ?>" aria-pressed="false">
