...
class Elonix_Toolkit_Post_Terms_Widget extends Elonix_Widget_Base {
	...
	public function get_es_widget_keywords() {
		return array( 'post', 'terms', 'taxonomy', 'category', 'tag', 'custom', 'badge', 'pill', 'eskit' );
	}
	...
	public function get_style_depends() {
		return array( 'elonix-widget-es-post-terms' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-post-terms-icon i'   => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .es-post-terms-icon svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				),
				'condition' => array(
					'enable_icon' => 'yes',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-post-terms-icon.es-icon-before' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .es-post-terms-icon.es-icon-after'  => 'margin-left: {{SIZE}}{{UNIT}};',
				),
				'condition' => array(
					'enable_icon' => 'yes',
				),
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-post-term-item',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'default'   => 'left',
				'selectors' => array(
					'{{WRAPPER}} .es-post-terms-container' => 'justify-content: {{VALUE}}; text-align: {{VALUE}};',
					'{{WRAPPER}} .es-post-terms-container.es-style-block' => 'align-items: {{VALUE}} === "center" ? "center" : ({{VALUE}} === "right" ? "flex-end" : "flex-start");',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-post-terms-container' => 'gap: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-post-term-item'   => 'color: {{VALUE}};',
					'{{WRAPPER}} .es-post-term-item a' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-post-term-item' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-post-term-item .es-post-terms-icon' => 'color: {{VALUE}};',
				),
				'condition' => array(
					'enable_icon' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-post-term-item:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .es-post-term-item a:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-post-term-item:hover' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-post-term-item:hover .es-post-terms-icon' => 'color: {{VALUE}};',
				),
				'condition' => array(
					'enable_icon' => 'yes',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em', 'rem' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-post-term-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em', 'rem' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-post-term-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em', 'rem' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-post-term-item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-post-terms-label',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-post-terms-label' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em', 'rem' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-post-terms-label' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-post-terms-separator' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'selectors' => array(
					'{{WRAPPER}} .es-post-terms-separator' => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'selectors' => array(
					'{{WRAPPER}} .es-post-terms-separator' => 'padding-left: {{SIZE}}{{UNIT}}; padding-right: {{SIZE}}{{UNIT}};',
				),
			)
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'container', 'class', 'es-post-terms-container es-style-' . esc_attr( $display_style ) );
		...
		if ( 'inline' === $display_style && ! empty( $settings['separator_type'] ) && 'none' !== $settings['separator_type'] ) {
			...
			if ( ! empty( $sep_char ) ) {
				$separator_html = '<span class="es-post-terms-separator">' . esc_html( $sep_char ) . '</span>';
			}
		}
		...
		if ( 'yes' === $settings['show_label'] && ! empty( $settings['custom_label'] ) ) {
			$label_html = '<span class="es-post-terms-label">' . esc_html( $settings['custom_label'] ) . '</span>';
		}
		...
		if ( 'yes' === $settings['enable_icon'] && ! empty( $settings['custom_icon']['value'] ) ) {
			...
			$icon_html     = '<span class="es-post-terms-icon es-icon-' . esc_attr( $icon_position ) . '">' . $rendered_icon . '</span>';
		}
		...
		<div <?php $this->print_render_attribute_string( 'container' ); ?>>
			...
			foreach ( $terms as $index => $term ) {
				...
				echo '<span class="es-post-term-item">';
				...
				echo '<span class="es-post-term-name">' . esc_html( $term_name ) . '</span>';
			...
			if ( 'yes' === $settings['show_remaining'] && $remaining > 0 ) {
				echo '<span class="es-post-terms-remaining">+' . esc_html( $remaining ) . '</span>';
			}
