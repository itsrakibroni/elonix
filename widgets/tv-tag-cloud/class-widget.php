...
// Reuse taxonomy engine from tv-categories if not loaded
if ( ! class_exists( 'Elonix_Toolkit_Taxonomy_Helper' ) ) {
	$elonix_fallback_path = ELONIX_ACC_PATH . 'widgets/tv-categories/helper-taxonomy.php';
...
class Elonix_Toolkit_Tag_Cloud_Widget extends Elonix_Widget_Base {
	...
	public function get_tv_widget_keywords() {
		return array( 'tag', 'cloud', 'category', 'taxonomy', 'filter', 'ajax', 'tvkit' );
	}
	...
	public function get_style_depends() {
		return array( 'elonix-widget-tv-tag-cloud' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'      => array(
					'{{WRAPPER}} .tv-tag-cloud-container' => 'grid-template-columns: repeat({{VALUE}}, 1fr);',
				),
				'condition'      => array(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-tag-cloud-container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-tag-cloud-container' => 'row-gap: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-tag-cloud-container' => 'column-gap: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-cloud-container' => 'justify-content: {{VALUE}};',
				),
				'condition' => array(
					'layout!' => array( 'category_cards', 'popular_topics' ),
				),
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-item, {{WRAPPER}} .tv-tag-item a' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-item:hover, {{WRAPPER}} .tv-tag-item:hover a' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'types'    => array( 'classic', 'gradient' ),
				'selector' => '{{WRAPPER}} .tv-tag-item:hover',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-item.tv-active, {{WRAPPER}} .tv-tag-item.tv-active a' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'types'    => array( 'classic', 'gradient' ),
				'selector' => '{{WRAPPER}} .tv-tag-item.tv-active',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-tag-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'separator'  => 'before',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-tag-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-tag-icon' => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-tag-icon' => 'width: {{SIZE}}{{UNIT}}; display: inline-flex; justify-content: center; align-items: center;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-tag-icon' => 'height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-icon, {{WRAPPER}} .tv-tag-icon i' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-icon' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-item:hover .tv-tag-icon, {{WRAPPER}} .tv-tag-item:hover .tv-tag-icon i' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-item:hover .tv-tag-icon' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-tag-icon, {{WRAPPER}} .tv-tag-icon img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-tag-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .tv-tag-item .tv-tag-icon' => 'margin-bottom: 0;',
					'{{WRAPPER}} .tv-tag-item' => 'align-items: center;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-icon' => 'opacity: {{SIZE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-count' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-count' => 'background-color: {{VALUE}};',
				),
				'condition' => array(
					'count_format' => 'badge',
				),
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-item:hover .tv-tag-count' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-item:hover .tv-tag-count' => 'background-color: {{VALUE}};',
				),
				'condition' => array(
					'count_format' => 'badge',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-tag-count' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'condition'  => array(
					'count_format' => 'badge',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-tag-count' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'condition'  => array(
					'count_format' => 'badge',
				),
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-tag-clear-filter-btn',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-clear-filter-btn' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-clear-filter-btn' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-clear-filter-btn:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-tag-clear-filter-btn:hover' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-tag-clear-filter-btn:hover',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-tag-clear-filter-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-tag-clear-filter-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
	...
	protected function render() {
		...
		$wrap_classes = array( 'tv-tag-cloud-wrap' );
		if ( 'link' !== $interaction ) {
			$wrap_classes[] = 'tv-tag-ajax-filter-active';
		}

		$container_classes = array( 'tv-tag-cloud-container', 'tv-layout-' . $layout );
		...
		<div class="<?php echo esc_attr( implode( ' ', $wrap_classes ) ); ?>" 
			...
			<div class="<?php echo esc_attr( implode( ' ', $container_classes ) ); ?>">
				...
				if ( ! empty( $terms ) ) {
					...
					?>
					<span class="tv-no-terms"><?php esc_html_e( 'No terms found.', 'elonix' ); ?></span>
					<?php
				}
				?>
			</div>
			...
			<?php if ( 'ajax_multi_select' === $interaction && ! empty( $terms ) ) : ?>
				<div class="tv-tag-clear-filter-wrap" style="display: none;">
					<button type="button" class="tv-tag-clear-filter-btn">
	...
	public static function render_single_tag( $term, $settings, $layout ) {
		...
		if ( $show_icon && ! empty( $term['icon_type'] ) ) {
			if ( 'font' === $term['icon_type'] && ! empty( $term['icon_value']['value'] ) ) {
				$icon_html = sprintf( '<span class="tv-tag-icon tv-icon-font"><i class="%s"></i></span>', esc_attr( $term['icon_value']['value'] ) );
			} elseif ( 'svg' === $term['icon_type'] && ! empty( $term['icon_value'] ) ) {
				$icon_html = sprintf( '<span class="tv-tag-icon tv-icon-svg"><img src="%s" alt="" /></span>', esc_url( $term['icon_value'] ) );
			} elseif ( 'image' === $term['icon_type'] && ! empty( $term['icon_value'] ) ) {
				$icon_html = sprintf( '<span class="tv-tag-icon tv-icon-img"><img src="%s" alt="" /></span>', esc_url( $term['icon_value'] ) );
			}
		}
		...
		if ( $show_count ) {
			...
			if ( 'parenthesis' === $count_format ) {
				$count_html = sprintf( '<span class="tv-tag-count">(%d)</span>', intval( $term['count'] ) );
			} elseif ( 'badge' === $count_format ) {
				$count_html = sprintf( '<span class="tv-tag-count tv-count-badge">%d</span>', intval( $term['count'] ) );
			} else {
				$count_html = sprintf( '<span class="tv-tag-count">%d</span>', intval( $term['count'] ) );
			}
		}
		...
		if ( $show_badge && ! empty( $settings['badge_text'] ) ) {
			$badge_html = sprintf( '<span class="tv-tag-badge">%s</span>', esc_html( $settings['badge_text'] ) );
		}
		...
		if ( $show_tooltip ) {
			...
			$tooltip_attrs = sprintf( ' data-tv-tooltip="%s" title="%s"', esc_attr( $tooltip_text ), esc_attr( $tooltip_text ) );
		}
		...
		<<?php echo esc_attr( $tag_tag ); ?> <?php echo $href_attr; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>" data-term-id="<?php echo esc_attr( $term['id'] ); ?>"<?php echo $tooltip_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?><?php echo $tag_style; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
			...
			<span class="tv-tag-text"><?php echo esc_html( $term['name'] ); ?></span>
	...
	public static function render_category_card( $term, $settings ) {
		...
		$href_attr  = ( 'a' === $tag_tag ) ? sprintf( ' href="%s"', esc_url( $term['url'] ) ) : ' type="button"';
		?>
		<<?php echo esc_attr( $tag_tag ); ?> <?php echo $href_attr; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> class="tv-tag-card-item tv-tag-item" data-term-id="<?php echo esc_attr( $term['id'] ); ?>">
			<?php if ( ! empty( $image_url ) ) : ?>
				<div class="tv-tag-card-image" style="background-image: url('<?php echo esc_url( $image_url ); ?>');"></div>
			<?php endif; ?>
			<div class="tv-tag-card-content">
				<h4 class="tv-tag-card-title"><?php echo esc_html( $term['name'] ); ?></h4>
				<?php if ( ! empty( $term['description'] ) ) : ?>
					<p class="tv-tag-card-desc"><?php echo esc_html( wp_trim_words( $term['description'], 12, '...' ) ); ?></p>
				<?php endif; ?>
				<?php if ( $show_count ) : ?>
					<span class="tv-tag-card-count">
						<?php
	...
	public static function render_popular_topic( $term, $settings ) {
		...
		$href_attr = ( 'a' === $tag_tag ) ? sprintf( ' href="%s"', esc_url( $term['url'] ) ) : ' type="button"';
		?>
		<div class="tv-tag-topic-block">
			<<?php echo esc_attr( $tag_tag ); ?> <?php echo $href_attr; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> class="tv-tag-topic-parent tv-tag-item" data-term-id="<?php echo esc_attr( $term['id'] ); ?>">
				<span class="tv-tag-text"><?php echo esc_html( $term['name'] ); ?></span>
				<?php if ( ! empty( $term['count'] ) ) : ?>
					<span class="tv-tag-count"><?php echo intval( $term['count'] ); ?></span>
				<?php endif; ?>
			</<?php echo esc_attr( $tag_tag ); ?>>

			<?php if ( ! empty( $term['children'] ) ) : ?>
				<div class="tv-tag-topic-children">
					<?php foreach ( $term['children'] as $child ) : ?>
						<?php
						$child_href = ( 'a' === $tag_tag ) ? sprintf( ' href="%s"', esc_url( $child['url'] ) ) : ' type="button"';
						?>
						<<?php echo esc_attr( $tag_tag ); ?> <?php echo $child_href; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> class="tv-tag-topic-child tv-tag-item" data-term-id="<?php echo esc_attr( $child['id'] ); ?>">
							<span class="tv-tag-text"><?php echo esc_html( $child['name'] ); ?></span>
							<span class="tv-tag-count"><?php echo intval( $child['count'] ); ?></span>
						</<?php echo esc_attr( $tag_tag ); ?>>
					<?php endforeach; ?>
				</div>
			<?php endif; ?>
