...
class Elonix_Toolkit_Gallery_AJAX {
	...
	public function __construct() {
		add_action( 'wp_ajax_tv_gallery_load_more', array( $this, 'ajax_load_more' ) );
		add_action( 'wp_ajax_nopriv_tv_gallery_load_more', array( $this, 'ajax_load_more' ) );
	}

	public function ajax_load_more() {
		check_ajax_referer( 'tv_gallery_ajax_nonce', 'nonce' );
