...
class Elonix_Toolkit_Post_Block_AJAX {
	...
	public function __construct() {
		add_action( 'wp_ajax_tv_post_block_fetch_posts', array( $this, 'ajax_fetch_posts' ) );
		add_action( 'wp_ajax_nopriv_tv_post_block_fetch_posts', array( $this, 'ajax_fetch_posts' ) );
	}
	...
	public function ajax_fetch_posts() {
		...
		check_ajax_referer( 'tv-post-block-nonce', 'security' );
