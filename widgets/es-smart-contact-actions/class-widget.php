...
class Elonix_Toolkit_Smart_Contact_Actions_Widget extends Elonix_Widget_Base {
	...
	public function get_name() {
		return 'es-smart-contact-actions';
	}
	...
	public function get_es_widget_keywords() {
		return array( 'contact', 'actions', 'whatsapp', 'messenger', 'email', 'call', 'telegram', 'eskit' );
	}
	...
	public function get_style_depends() {
		return array( 'elonix-widget-es-smart-contact-actions' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-container' => 'bottom: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-align-right' => 'right: {{SIZE}}{{UNIT}}; left: auto;',
					'{{WRAPPER}} .es-sca-align-left'  => 'left: {{SIZE}}{{UNIT}}; right: auto;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-sca-bg-glass' => 'backdrop-filter: blur({{SIZE}}px); -webkit-backdrop-filter: blur({{SIZE}}px);',
					'{{WRAPPER}} .es-sca-card-drawer.es-sca-bg-glass' => 'backdrop-filter: blur({{SIZE}}px); -webkit-backdrop-filter: blur({{SIZE}}px);',
				),
				'condition' => array(
					'bg_preset' => 'glass',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-trigger-btn' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-trigger-btn svg, {{WRAPPER}} .es-sca-trigger-btn i' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-trigger-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .es-sca-trigger-btn' => 'background-color: {{VALUE}}; background-image: none;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-trigger-btn'     => 'color: {{VALUE}};',
					'{{WRAPPER}} .es-sca-trigger-btn svg' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'trigger_border',
				'selector' => '{{WRAPPER}} .es-sca-trigger-btn',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-trigger-btn:hover' => 'background-color: {{VALUE}}; background-image: none;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-trigger-btn:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .es-sca-trigger-btn:hover svg' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-sca-trigger-btn:hover',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-item-btn' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-item-btn svg, {{WRAPPER}} .es-sca-item-btn i' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-dial-open .es-sca-item:nth-child(1)' => 'transform: translateY(-{{SIZE}}px);',
					'{{WRAPPER}} .es-sca-dial-open .es-sca-item:nth-child(2)' => 'transform: translateY(-calc({{SIZE}}px * 2));',
					'{{WRAPPER}} .es-sca-dial-open .es-sca-item:nth-child(3)' => 'transform: translateY(-calc({{SIZE}}px * 3));',
					'{{WRAPPER}} .es-sca-dial-open .es-sca-item:nth-child(4)' => 'transform: translateY(-calc({{SIZE}}px * 4));',
					'{{WRAPPER}} .es-sca-dial-open .es-sca-item:nth-child(5)' => 'transform: translateY(-calc({{SIZE}}px * 5));',
					'{{WRAPPER}} .es-sca-item-list' => 'gap: {{SIZE}}px;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-item-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-item-btn' => 'background-color: {{VALUE}}; background-image: none;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-item-btn'     => 'color: {{VALUE}};',
					'{{WRAPPER}} .es-sca-item-btn svg' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'item_border',
				'selector' => '{{WRAPPER}} .es-sca-item-btn',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-item-btn:hover' => 'background-color: {{VALUE}}; background-image: none;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-item-btn:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .es-sca-item-btn:hover svg' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-sca-item-btn:hover',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-card-drawer' => 'width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-card-drawer' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'card_border',
				'selector' => '{{WRAPPER}} .es-sca-card-drawer',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-card-drawer' => 'background-color: {{VALUE}}; background-image: none;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-card-header' => 'background-color: {{VALUE}}; background-image: none;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-card-header' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-card-header h4' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-sca-card-header h4',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-card-header p' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'card_desc_typo',
				'selector' => '{{WRAPPER}} .es-sca-card-header p',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-card-body' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-agent-row' => 'background-color: {{VALUE}}; background-image: none;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-agent-row' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-agent-row' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-sca-agent-row',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-agent-info h5' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-sca-agent-info h5',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-agent-info span' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-sca-agent-info span',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-agent-link-btn' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-agent-link-btn svg, {{WRAPPER}} .es-sca-agent-link-btn i' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-agent-link-btn' => 'background-color: {{VALUE}}; background-image: none;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-agent-link-btn' => 'color: {{VALUE}};',
					'{{WRAPPER}} .es-sca-agent-link-btn svg' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-agent-link-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-agent-link-btn:hover' => 'background-color: {{VALUE}}; background-image: none;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-agent-link-btn:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .es-sca-agent-link-btn:hover svg' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-tooltip'        => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .es-sca-tooltip::after' => 'border-color: transparent transparent transparent {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-tooltip' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'tooltip_typo',
				'selector' => '{{WRAPPER}} .es-sca-tooltip',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-tooltip' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-tooltip' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-badge' => 'background-color: {{VALUE}};',
				),
				'condition' => array(
					'enable_badge' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-badge' => 'color: {{VALUE}};',
				),
				'condition' => array(
					'enable_badge' => 'yes',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-badge' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'condition'  => array(
					'enable_badge' => 'yes',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-badge' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'condition'  => array(
					'enable_badge' => 'yes',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-status-indicator' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-status-indicator' => 'border-width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-status-indicator' => 'border-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-status-online' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-status-lunch' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-status-offline' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'.es-sca-qr-overlay' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-qr-modal' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-qr-modal' => 'width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-qr-modal' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-qr-modal' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-sca-qr-modal',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-qr-header span' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .es-sca-qr-header span',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-qr-close' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-qr-close:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .es-sca-stack-wrapper' => 'background-color: {{VALUE}}; background-image: none;',
					'{{WRAPPER}} .es-sca-toolbar-panel' => 'background-color: {{VALUE}}; background-image: none;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-stack-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .es-sca-toolbar-panel' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .es-sca-stack-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .es-sca-toolbar-panel' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'stack_border',
				'selector' => '{{WRAPPER}} .es-sca-stack-wrapper, {{WRAPPER}} .es-sca-toolbar-panel',
			)
		);
	...
	protected function render() {
		...
		$align_class = 'es-sca-align-right';
		$dock_pos    = isset( $settings['bar_position'] ) ? $settings['bar_position'] : 'bottom-right';
		if ( strpos( $dock_pos, 'left' ) !== false ) {
			$align_class = 'es-sca-align-left';
		}

		$pos_class    = 'es-sca-pos-' . esc_attr( $dock_pos );
		$layout_class = 'es-sca-layout-' . esc_attr( $settings['layout_type'] );
		$preset_class = 'es-sca-bg-' . esc_attr( $settings['bg_preset'] );
		$anim_class   = 'es-sca-anim-' . esc_attr( $settings['attention_anim'] );

		// Neumorphism dynamic angles
		$style_attrs = '';
		if ( 'neumorphism' === $settings['bg_preset'] && isset( $settings['neumorphism_light_angle']['size'] ) ) {
			$style_attrs = ' style="--es-sca-neumorphic-angle: ' . (int) $settings['neumorphism_light_angle']['size'] . 'deg;"';
		}

		?>
		<div class="es-sca-container <?php echo esc_attr( $align_class ); ?> <?php echo esc_attr( $pos_class ); ?> <?php echo esc_attr( $layout_class ); ?>" data-config="<?php echo esc_attr( wp_json_encode( $js_config ) ); ?>">
			...
			if ( 'single' === $settings['layout_type'] ) :
				...
				<a href="<?php echo esc_url( $action_link ); ?>" class="es-sca-trigger-btn <?php echo esc_attr( $preset_class ); ?> <?php echo esc_attr( $anim_class ); ?>" aria-label="<?php echo esc_attr( $first_item['label'] ); ?>" <?php echo $style_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- built above with (int) cast, no raw string interpolation. ?>>
					...
					<?php if ( 'yes' === $settings['enable_badge'] ) : ?>
						<span class="es-sca-badge"><?php echo esc_html( $settings['badge_val'] ); ?></span>
					<?php endif; ?>
				</a>

			<?php elseif ( 'speed_dial' === $settings['layout_type'] || 'radial' === $settings['layout_type'] ) : ?>
				<div class="es-sca-item-list" style="display: none;">
					<?php
					foreach ( $settings['action_items'] as $index => $item ) :
						$item_link  = $this->get_action_link( $item );
						$tooltip_id = 'es-sca-tooltip-' . $this->get_id() . '-' . $index;
						?>
						<div class="es-sca-item" data-action="<?php echo esc_attr( $item['action_type'] ); ?>">
							<a href="<?php echo esc_url( $item_link ); ?>" class="es-sca-item-btn" aria-describedby="<?php echo esc_attr( $tooltip_id ); ?>">
							...
							<?php if ( ! empty( $item['tooltip_text'] ) ) : ?>
								<span id="<?php echo esc_attr( $tooltip_id ); ?>" class="es-sca-tooltip" role="tooltip"><?php echo esc_html( $item['tooltip_text'] ); ?></span>
							<?php endif; ?>
						</div>
					<?php endforeach; ?>
				</div>
				...
				<button class="es-sca-trigger-btn <?php echo esc_attr( $preset_class ); ?> <?php echo esc_attr( $anim_class ); ?>" aria-expanded="false" aria-haspopup="true" aria-label="<?php echo esc_attr__( 'Toggle Contact Options', 'elonix' ); ?>" <?php echo $style_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- built above with (int) cast, no raw string interpolation. ?>>
					...
					<span class="es-sca-trigger-icon-close" style="display: none;">
			...
			<?php elseif ( 'contact_card' === $settings['layout_type'] ) : ?>
				<div class="es-sca-card-drawer <?php echo esc_attr( $preset_class ); ?>" style="display: none;" <?php echo $style_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- built above with (int) cast, no raw string interpolation. ?>>
					...
					<div class="es-sca-card-body">
						<?php
						foreach ( $settings['action_items'] as $index => $item ) :
							$item_link = $this->get_action_link( $item );
							?>
							<div class="es-sca-agent-row" data-action="<?php echo esc_attr( $item['action_type'] ); ?>">
								<?php if ( 'whatsapp' === $item['action_type'] && ! empty( $item['agent_photo']['url'] ) ) : ?>
									<div class="es-sca-agent-avatar">
										<img src="<?php echo esc_url( $item['agent_photo']['url'] ); ?>" alt="<?php echo esc_attr( $item['label'] ); ?>" loading="lazy" />
										<span class="es-sca-status-indicator es-sca-status-offline" title="<?php echo esc_attr__( 'Offline', 'elonix' ); ?>"></span>
									</div>
								<?php endif; ?>
								
								<div class="es-sca-agent-info">
								...
								<a href="<?php echo esc_url( $item_link ); ?>" class="es-sca-agent-link-btn" aria-label="<?php echo esc_attr( $item['label'] ); ?>">
									<?php if ( ! empty( $item['item_icon'] ) ) : ?>
										<?php Icons_Manager::render_icon( $item['item_icon'], array( 'aria-hidden' => 'true' ) ); ?>
									<?php endif; ?>
								</a>
							...
							<?php if ( 'inline_form' === $item['action_type'] && ! empty( $item['action_value'] ) ) : ?>
								<div class="es-sca-inline-form-wrapper">
			...
			<?php if ( 'yes' === $settings['enable_qr'] ) : ?>
				<div class="es-sca-qr-modal" style="display: none;">
					<div class="es-sca-qr-header">
						<span><?php echo esc_html__( 'Scan to Chat Mobile', 'elonix' ); ?></span>
						<button class="es-sca-qr-close" aria-label="<?php echo esc_attr__( 'Close Modal', 'elonix' ); ?>">&times;</button>
					</div>
					<div class="es-sca-qr-canvas-wrapper">
						<canvas class="es-sca-qr-canvas"></canvas>
					</div>
				</div>
			<?php endif; ?>
