...
class Elonix_Toolkit_Categories_Widget extends Elonix_Widget_Base {
	...
	public function get_tv_widget_keywords() {
		return array( 'categories', 'terms', 'taxonomies', 'grid', 'carousel', 'tvkit' );
	}
	...
	public function get_style_depends() {
		return array( 'elonix-widget-tv-categories', 'swiper' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .tv-categories-grid-wrapper' => 'grid-template-columns: repeat({{VALUE}}, 1fr);',
				),
				'condition' => array(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-card' => 'height: {{SIZE}}{{UNIT}};',
				),
				'condition'  => array(
					'layout!' => array( 'classic', 'icon_list' ),
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-categories-grid-wrapper' => 'gap: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .tv-cat-card-classic' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-cat-card, {{WRAPPER}} .tv-cat-card-classic',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-card'         => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .tv-cat-card-classic' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => esc_html__( 'Background', 'elonix' ),
				'types'    => array( 'classic', 'gradient' ),
				'selector' => '{{WRAPPER}} .tv-cat-card:hover, {{WRAPPER}} .tv-cat-card-classic:hover',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-card'         => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .tv-cat-card-classic' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'separator'  => 'before',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-image-wrapper' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-image-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-card-overlay' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-image-wrapper img' => '--tv-image-hover-zoom: {{SIZE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-image-wrapper img' => '--tv-image-hover-brightness: {{SIZE}}%;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-image-wrapper img' => '--tv-image-hover-contrast: {{SIZE}}%;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-icon i' => 'font-size: {{SIZE}}{{UNIT}}; line-height: 1;',
					'{{WRAPPER}} .tv-cat-icon svg, {{WRAPPER}} .tv-cat-icon img' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; line-height: 1;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-icon' => 'width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-icon' => 'height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-icon-before' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .tv-cat-icon-after'  => 'margin-left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .tv-cat-icon-above'  => 'margin-bottom: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-icon' => 'align-self: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-icon i'   => 'color: {{VALUE}};',
					'{{WRAPPER}} .tv-cat-icon svg' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-icon' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-icon' => 'opacity: {{SIZE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-item:hover .tv-cat-icon i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .tv-cat-item:hover .tv-cat-icon svg' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-item:hover .tv-cat-icon' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-cat-item:hover .tv-cat-icon',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-item:hover .tv-cat-icon' => 'opacity: {{SIZE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-title'      => 'color: {{VALUE}};',
					'{{WRAPPER}} .tv-cat-title-link' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-cat-title, {{WRAPPER}} .tv-cat-title-link',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-title, {{WRAPPER}} .tv-cat-title-link' => '-webkit-text-stroke-width: {{SIZE}}{{UNIT}}; text-stroke-width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-title, {{WRAPPER}} .tv-cat-title-link' => '-webkit-text-stroke-color: {{VALUE}}; text-stroke-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-item:hover .tv-cat-title'      => 'color: {{VALUE}};',
					'{{WRAPPER}} .tv-cat-item:hover .tv-cat-title-link' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-description' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-cat-description',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-parent-label' => 'color: {{VALUE}};',
					'{{WRAPPER}} .tv-cat-parent-link'  => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-cat-parent-label, {{WRAPPER}} .tv-cat-parent-link',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-count' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-count' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-count' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-item:hover .tv-cat-count' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => esc_html__( 'Background', 'elonix' ),
				'types'    => array( 'classic', 'gradient' ),
				'selector' => '{{WRAPPER}} .tv-cat-item:hover .tv-cat-count',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'separator'    => 'before',
				'selectors'    => array(
					'{{WRAPPER}} .tv-cat-count' => 'position: absolute; top: 15px; right: 15px; margin-left: 0; z-index: 3;',
					'{{WRAPPER}} .tv-cat-card'  => 'position: relative;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'      => 'no',
				'selectors'    => array(
					'{{WRAPPER}} .tv-cat-count' => 'border-radius: 50%; min-width: 24px; height: 24px; padding: 0 !important; display: inline-flex; align-items: center; justify-content: center;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-badge' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-badge' => 'background-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-cat-card-glass' => 'backdrop-filter: blur({{SIZE}}px); -webkit-backdrop-filter: blur({{SIZE}}px);',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .tv-cat-card-glass' => 'border: 1px solid {{VALUE}};',
				),
			)
		);
	...
	protected function render_category_icon( $term, $settings, $position = '' ) {
		...
		$classes = array( 'tv-cat-icon' );
		if ( $position ) {
			$classes[] = 'tv-cat-icon-' . $position;
		}
		...
		if ( 'font' === $type ) {
			...
			echo '<img src="' . esc_url( $val ) . '" alt="" aria-hidden="true" class="tv-cat-svg-icon" style="display: inline-block; vertical-align: middle; width: 1em; height: 1em;" />';
		} elseif ( 'image' === $type ) {
			echo '<img src="' . esc_url( $val ) . '" alt="" aria-hidden="true" class="tv-cat-image-icon" style="display: inline-block; vertical-align: middle; width: 1em; height: 1em; object-fit: contain;" />';
		}
		echo '</span>';
	}
	...
	protected function render() {
		...
		if ( empty( $terms ) ) {
			echo '<div class="elementor-no-results tv-categories-empty">' . esc_html__( 'No categories found matching your query.', 'elonix' ) . '</div>';
			return;
		}
		...
		<<?php echo esc_attr( $container_tag ); ?><?php echo $attrs_str; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
			...
			<?php if ( 'carousel' === $layout ) : ?>
				...
				<div class="swiper-container tv-categories-swiper">
					...
					<?php if ( 'none' !== $settings['carousel_nav'] ) : ?>
						<!-- Navigation Arrows -->
						<div class="swiper-button-prev tv-carousel-arrow tv-arrow-<?php echo esc_attr( $settings['carousel_nav'] ); ?>"></div>
						<div class="swiper-button-next tv-carousel-arrow tv-arrow-<?php echo esc_attr( $settings['carousel_nav'] ); ?>"></div>
					<?php endif; ?>

					<?php if ( 'none' !== $settings['carousel_pag'] ) : ?>
						<!-- Pagination -->
						<div class="swiper-pagination tv-carousel-pagination tv-pag-<?php echo esc_attr( $settings['carousel_pag'] ); ?>"></div>
					<?php endif; ?>
				</div>
			<?php else : ?>
				<!-- Standard Grids / Lists container -->
				<div class="<?php echo esc_attr( $is_list ? 'tv-categories-list tv-categories-list-wrapper' : 'tv-categories-grid-wrapper' ); ?>" <?php echo $is_list ? 'role="none"' : ''; ?>>
					<?php foreach ( $terms as $term ) : ?>
						<?php $this->render_card( $term, $settings, $layout ); ?>
					<?php endforeach; ?>
				</div>
	...
	protected function render_card( $term, $settings, $layout ) {
		...
		$card_classes = array( 'tv-cat-item' );
		if ( $is_list ) {
			$card_classes[] = 'tv-cat-card-classic';
		} else {
			$card_classes[] = 'tv-cat-card';
			if ( 'glass_card' === $layout ) {
				$card_classes[] = 'tv-cat-card-glass';
			}
		}
		if ( ! empty( $settings['hover_effect'] ) && 'none' !== $settings['hover_effect'] ) {
			$card_classes[] = 'tv-hover-effect-' . esc_attr( $settings['hover_effect'] );
		}
		...
		<<?php echo esc_attr( $card_tag ); ?><?php echo $attrs_str; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?><?php echo $card_style_attr; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
			...
			if ( ! empty( $badge_text ) ) :
				?>
				<!-- Highlight Badge -->
				<span class="tv-cat-badge"><?php echo esc_html( $badge_text ); ?></span>
			<?php endif; ?>
			...
			<?php if ( $is_list ) : ?>
				...
				<?php
				if ( $show_title ) :
					$title_classes      = array( 'tv-cat-title' );
					$title_link_classes = array( 'tv-cat-title-link' );
					if ( 'yes' === $settings['title_gradient_enable'] ) {
						...
						if ( $has_gradient ) {
							$title_classes[]      = 'tv-title-gradient-active';
							$title_link_classes[] = 'tv-title-gradient-active';
						}
					}
					?>
				...
				<?php if ( $show_count ) : ?>
					<span class="tv-cat-count"><?php echo intval( $term['count'] ); ?> <span class="screen-reader-text"><?php esc_html_e( 'items in this category', 'elonix' ); ?></span></span>
				<?php endif; ?>
				...
				<?php if ( $show_nested && ! empty( $term['children'] ) ) : ?>
					...
					<?php if ( 'accordion' === $nested_style ) : ?>
						...
						<button class="tv-cat-toggle-btn" aria-expanded="false" aria-controls="tv-children-list-<?php echo esc_attr( $term['id'] ); ?>" aria-label="<?php esc_attr_e( 'Toggle child categories', 'elonix' ); ?>">
							<?php if ( 'yes' === $settings['show_toggle_icon'] ) : ?>
								<span class="tv-cat-icon-collapsed">
									<?php $this->render_toggle_icon( $settings, 'collapsed' ); ?>
								</span>
								<span class="tv-cat-icon-expanded" style="display: none;">
						...
						<ul class="tv-categories-tree tv-cat-children-list tv-cat-children-hidden" id="tv-children-list-<?php echo esc_attr( $term['id'] ); ?>" role="group" aria-hidden="true">
							<?php foreach ( $term['children'] as $child ) : ?>
								<li class="tv-cat-child-item" role="treeitem">
									<a href="<?php echo esc_url( $child['url'] ); ?>" class="tv-cat-child-link"><?php echo esc_html( $child['name'] ); ?></a>
								</li>
							<?php endforeach; ?>
						</ul>
					<?php else : ?>
						<!-- Standard Navigation tree pattern -->
						<ul class="tv-categories-tree tv-cat-children-list" role="group">
							<?php foreach ( $term['children'] as $child ) : ?>
								<li class="tv-cat-child-item" role="treeitem">
									<a href="<?php echo esc_url( $child['url'] ); ?>" class="tv-cat-child-link"><?php echo esc_html( $child['name'] ); ?></a>
								</li>
			...
			<?php else : ?>
				...
				<?php if ( $show_image && ! empty( $term['image'] ) && 'background_card' !== $layout ) : ?>
					<!-- Card Image Wrapper -->
					<div class="tv-cat-image-wrapper">
						<img src="<?php echo esc_url( $term['image'] ); ?>" alt="<?php echo esc_attr( $term['name'] ); ?>" loading="lazy" />
						<div class="tv-cat-card-overlay"></div>
					</div>
				<?php endif; ?>

				<!-- Card Body -->
				<div class="tv-cat-card-body">
					...
					<div class="tv-cat-card-header-row">
						<?php
						if ( $show_icon && ! empty( $term['icon_value'] ) && 'before' === $icon_pos ) :
							?>
						...
						<?php if ( $show_parent && ! empty( $term['parent_name'] ) ) : ?>
							...
							<span class="tv-cat-parent-label">
								<?php esc_html_e( 'in', 'elonix' ); ?>
								<a href="<?php echo esc_url( $term['parent_url'] ); ?>" class="tv-cat-parent-link">
					...
					<?php if ( $show_desc && ! empty( $term['description'] ) ) : ?>
						<!-- Description -->
						<p class="tv-cat-description"><?php echo esc_html( wp_trim_words( $term['description'], 12 ) ); ?></p>
					<?php endif; ?>

					<?php if ( $show_read ) : ?>
						<!-- Read More Link -->
						<a href="<?php echo esc_url( $term['url'] ); ?>" class="tv-cat-read-more">
