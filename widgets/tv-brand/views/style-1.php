...
?>
<<?php echo esc_html( $wrapper_tag ); ?> <?php echo $is_link ? $this->get_render_attribute_string( $item_key ) : ''; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> class="tv-brand__item elementor-repeater-item-<?php echo esc_attr( $item['_id'] ); ?>">
	<figure class="tv-brand__figure">
		<div class="tv-brand__logo">
		...
		<?php if ( 'yes' === $settings['show_brand_name'] && ! empty( $item['brand_name'] ) ) : ?>
			<figcaption class="tv-brand__title"><?php echo esc_html( $item['brand_name'] ); ?></figcaption>
		<?php endif; ?>

		<?php if ( 'yes' === $settings['show_tooltip'] && ! empty( $item['brand_name'] ) ) : ?>
			<div class="tv-brand__tooltip"><?php echo esc_html( $item['brand_name'] ); ?></div>
		<?php endif; ?>
	</figure>
