...
class Elonix_Toolkit_Brand_Widget extends Elonix_Widget_Base {
	...
	public function get_keywords() {
		return array( 'brand', 'logo', 'carousel', 'grid', 'client', 'partner', 'tvkit' );
	}

	public function get_style_depends() {
		return array( 'elonix-widget-tv-brand', 'swiper' );
	}
	...
	protected function register_content_layout_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'default'   => 5,
				'selectors' => array(
					'{{WRAPPER}} .tv-brand__grid' => '--tv-brand-columns: {{VALUE}};',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-brand__grid' => '--tv-brand-gap-x: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-brand__grid' => '--tv-brand-gap-y: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .tv-brand__item' => 'min-height: {{SIZE}}{{UNIT}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => 'yes',
				'selectors' => array(
					'{{WRAPPER}} .tv-brand__item' => 'height: 100%;',
				),
			)
		);
	...
	protected function register_style_card_controls() {
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'card_bg',
				'selector' => '{{WRAPPER}} .tv-brand__item',
			)
		);
		$this->add_group_control(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .tv-brand__item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'card_padding',
			array(
				...
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .tv-brand__item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'card_margin',
			array(
				...
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'selectors' => array( '{{WRAPPER}} .tv-brand__item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ),
			)
		);
		$this->add_group_control(
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'card_bg_hover',
				'selector' => '{{WRAPPER}} .tv-brand__item:hover',
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Border::get_type(),
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .tv-brand__item:hover' => 'transform: translateY({{SIZE}}{{UNIT}});' ),
			)
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .tv-brand__item' => 'transition: all {{SIZE}}s ease;' ),
				'separator' => 'before',
			)
		);
		$this->end_controls_section();
	...
	protected function register_style_logo_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array( '{{WRAPPER}} .tv-brand__logo img' => 'width: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'logo_height',
			array(
				...
				'size_units' => array( 'px', 'vh' ),
				'range'      => array( 'px' => array( 'max' => 500 ) ),
				'selectors'  => array( '{{WRAPPER}} .tv-brand__logo img' => 'height: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'logo_max_width',
			array(
				...
				'size_units' => array( 'px', '%' ),
				'range'      => array( 'px' => array( 'max' => 500 ) ),
				'selectors'  => array( '{{WRAPPER}} .tv-brand__logo img' => 'max-width: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_responsive_control(
			'logo_max_height',
			array(
				...
				'size_units' => array( 'px', 'vh' ),
				'range'      => array( 'px' => array( 'max' => 500 ) ),
				'selectors'  => array( '{{WRAPPER}} .tv-brand__logo img' => 'max-height: {{SIZE}}{{UNIT}};' ),
			)
		);
		$this->add_control(
			'logo_object_fit',
			array(
				...
				'default'   => 'contain',
				'selectors' => array( '{{WRAPPER}} .tv-brand__logo img' => 'object-fit: {{VALUE}};' ),
			)
		);
		$this->add_responsive_control(
			'logo_alignment',
			array(
				...
				'selectors' => array( '{{WRAPPER}} .tv-brand__figure' => 'justify-content: {{VALUE}};' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .tv-brand__logo img' => 'opacity: {{SIZE}};' ),
			)
		);
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-brand__logo img',
			)
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .tv-brand__item:hover .tv-brand__logo img' => 'opacity: {{SIZE}};' ),
			)
		);
		$this->add_control(
			'logo_scale_hover',
			array(
				...
				'selectors' => array( '{{WRAPPER}} .tv-brand__item:hover .tv-brand__logo img' => 'transform: scale({{SIZE}});' ),
			)
		);
		$this->add_control(
			'logo_rotate_hover',
			array(
				...
				'selectors' => array( '{{WRAPPER}} .tv-brand__item:hover .tv-brand__logo img' => 'transform: rotate({{SIZE}}deg);' ),
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Css_Filter::get_type(),
			array(
				...
				'selector' => '{{WRAPPER}} .tv-brand__item:hover .tv-brand__logo img',
			)
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .tv-brand__logo img' => 'transition: all {{SIZE}}s ease;' ),
				'separator' => 'before',
			)
		);
		$this->end_controls_section();
	...
	protected function register_style_brand_name_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .tv-brand__title',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .tv-brand__title' => 'color: {{VALUE}};' ),
			)
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .tv-brand__item:hover .tv-brand__title' => 'color: {{VALUE}};' ),
			)
		);
		$this->end_controls_tab();
		$this->end_controls_tabs();
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::SLIDER,
				'selectors' => array( '{{WRAPPER}} .tv-brand__title' => 'margin-top: {{SIZE}}{{UNIT}};' ),
				'separator' => 'before',
			)
		);
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .tv-brand__title' => 'text-align: {{VALUE}};' ),
			)
		);
		$this->end_controls_section();
	}
	...
	protected function render() {
		...
		$wrapper_classes = array(
			'tv-brand',
			'tv-brand--' . esc_attr( $settings['layout_mode'] ),
		);
