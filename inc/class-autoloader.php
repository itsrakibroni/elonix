...
class Autoloader {
	...
	private static $class_map = array(
		...
		'Elonix_Toolkit\Widgets\Search\Widget'         => array( 'Elonix_Toolkit_Search_Widget', 'widgets/tv-search/class-widget.php' ),
		'Elonix_Toolkit\Widgets\Search_Results\Widget' => array( 'Elonix_Toolkit_Search_Results_Widget', 'widgets/tv-search-results/class-widget.php' ),
		'Elonix_Toolkit\Widgets\Categories\Widget'     => array( 'Elonix_Toolkit_Categories_Widget', 'widgets/tv-categories/class-widget.php' ),
		'Elonix_Toolkit\Widgets\Post_List\Widget'      => array( 'Elonix_Toolkit_Post_List_Widget', 'widgets/tv-post-list/class-widget.php' ),
		'Elonix_Toolkit\Widgets\Tag_Cloud\Widget'      => array( 'Elonix_Toolkit_Tag_Cloud_Widget', 'widgets/tv-tag-cloud/class-widget.php' ),
		'Elonix_Toolkit\Widgets\Post_Block\Widget'     => array( 'Elonix_Toolkit_Post_Block_Widget', 'widgets/tv-post-block/class-widget.php' ),
		'Elonix_Toolkit\Widgets\Post_Block\Renderer'   => array( 'Elonix_Toolkit_Post_Block_Renderer', 'widgets/tv-post-block/class-renderer.php' ),
		'Elonix_Toolkit\Widgets\Back_To_Top\Widget'    => array( 'Elonix_Toolkit_Back_To_Top_Widget', 'widgets/tv-back-to-top/class-widget.php' ),
		'Elonix_Toolkit\Widgets\Smart_Contact_Actions\Widget' => array( 'Elonix_Toolkit_Smart_Contact_Actions_Widget', 'widgets/tv-smart-contact-actions/class-widget.php' ),
	...
	private static $legacy_map = array(
		...
		'Elonix_Toolkit_Search_Widget'                => 'widgets/tv-search/class-widget.php',
		'Elonix_Toolkit_Search_Results_Widget'        => 'widgets/tv-search-results/class-widget.php',
		'Elonix_Toolkit_Categories_Widget'            => 'widgets/tv-categories/class-widget.php',
		'Elonix_Toolkit_Post_List_Widget'             => 'widgets/tv-post-list/class-widget.php',
		'Elonix_Toolkit_Tag_Cloud_Widget'             => 'widgets/tv-tag-cloud/class-widget.php',
		'Elonix_Toolkit_Post_Block_Widget'            => 'widgets/tv-post-block/class-widget.php',
		'Elonix_Toolkit_Post_Block_Renderer'          => 'widgets/tv-post-block/class-renderer.php',
		'Elonix_Toolkit_Back_To_Top_Widget'           => 'widgets/tv-back-to-top/class-widget.php',
		'Elonix_Toolkit_Smart_Contact_Actions_Widget' => 'widgets/tv-smart-contact-actions/class-widget.php',
	...
	public static function autoload( $class ) {
		...
		if ( strncmp( $prefix, $class, $prefix_len ) === 0 ) {
			...
			$widget_folder_map = array(
				'post-block' => 'tv-post-block',
				'categories' => 'tv-categories',
				'post-list'  => 'tv-post-list',
				'search'     => 'tv-search',
				'search-results' => 'tv-search-results',
				'tag-cloud'  => 'tv-tag-cloud',
			);
