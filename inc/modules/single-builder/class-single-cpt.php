...
class Elonix_Toolkit_Single_CPT {
	...
	public function register_post_type() {
		...
		register_post_type( 'tv_single', $args );
	}

	/**
	 * Ensure Elementor CPT support option registers tv_single templates automatically.
	 */
	public function add_elementor_support() {
		...
		if ( ! in_array( 'tv_single', $cpts, true ) ) {
			$cpts[] = 'tv_single';
