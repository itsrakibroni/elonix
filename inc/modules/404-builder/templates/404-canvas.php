...
$tv_404_builder   = class_exists( 'Elonix_Toolkit_404_Builder' ) ? Elonix_Toolkit_404_Builder::instance() : null;
$tv_should_render = $tv_404_builder && $tv_404_builder->router && method_exists( $tv_404_builder->router, 'should_render_404_template' ) && $tv_404_builder->router->should_render_404_template();
...
$show_header = ( 'yes' === ( Elonix_Settings::get( 'tv_404_show_header' ) ?? 'yes' ) );
$show_footer = ( 'yes' === ( Elonix_Settings::get( 'tv_404_show_footer' ) ?? 'yes' ) );
...
$custom_header_code = Elonix_Settings::get( 'tv_404_custom_header_code' ) ?? '';
...
if ( $template_id ) {
	echo '<main class="tv-404-page-content tv-builder-container" role="main">';
...
$custom_footer_code = Elonix_Settings::get( 'tv_404_custom_footer_code' ) ?? '';
