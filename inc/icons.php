...
class Elonix_Custom_Icons {
	...
	public function enqueue_styles() {
		...
		if ( ! wp_style_is( 'tv-boxicons', 'enqueued' ) ) {
			wp_enqueue_style( 'tv-boxicons', $this->plugin_url . 'assets/icons/boxicons/boxicons.min.css', array(), ELONIX_VERSION );
		}
		if ( ! wp_style_is( 'tv-boxicons-brands', 'enqueued' ) ) {
			wp_enqueue_style( 'tv-boxicons-brands', $this->plugin_url . 'assets/icons/boxicons/boxicons-brands.min.css', array(), ELONIX_VERSION );
		}
	}

	public function enqueue_editor_styles() {
		// Enqueue styles for the editor, as they are also needed there.
		if ( ! wp_style_is( 'tv-boxicons-editor', 'enqueued' ) ) {
			wp_enqueue_style( 'tv-boxicons-editor', $this->plugin_url . 'assets/icons/boxicons/boxicons.min.css', array(), ELONIX_VERSION );
		}
		if ( ! wp_style_is( 'tv-boxicons-brands-editor', 'enqueued' ) ) {
			wp_enqueue_style( 'tv-boxicons-brands-editor', $this->plugin_url . 'assets/icons/boxicons/boxicons-brands.min.css', array(), ELONIX_VERSION );
		}
