(function($) {
	...
	class ESTestimonialHandler extends elementorModules.frontend.handlers.Base {
		getDefaultSettings() {
			return {
				selectors: {
					carousel: '.es-testimonial__carousel',
		...
		initializeSwiper() {
			...
			if (rawSettings.navigation === 'yes') {
				swiperOptions.navigation = {
					nextEl: this.$element.find('.es-swiper-button-next')[0],
					prevEl: this.$element.find('.es-swiper-button-prev')[0],
				};
			}
